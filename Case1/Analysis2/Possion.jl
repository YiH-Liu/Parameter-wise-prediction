...
# In this script, we generate the result for Case S1 in SUpplementary material document
# Variable P indicate P^\star in the main document
# Variable ρ indicate ρ^\star in the main document
# Variable k1 indicate λ_1^\star in the main document
# Variable k2 indicate λ_2^\star in the main document
...
function model(t,a) 
    ...
    x = 0:1:199
    c1,c2 = solution(x,t,a[1],a[2],a[3],a[4],0.5,0.2,19.5,199)
    return c1,c2
end
...
x_range = 1:1:200
x = 1:1:200
s1b1a = plot(x_range, lb1, lw=0, fillrange=ub1, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         ...
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s1b1a = plot!(x,c1mle.*J,color=:red,legend=false,lw=2,ls=:dash)
s1b1a = hline!([0],lw=2,ls=:dash,color=:black)
s1b1a = scatter!(1:step:200,data1,color=:red,markerstrokecolor=:red,ms=1.5)
s1b1a = annotate!(100, -43.5,text(L"i", :left, tfs))
s1b1a = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{1} ", :left, tfs,rotation=90))
s1b1a = annotate!(-200*0.5, 110.5, text(L"(\mathrm{b})", :left, tfs))


s1b1b = plot(x_range, lb2, lw=0, fillrange=ub2, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
...
s1b1b = scatter!(1:step:200,data2,color=:green,markerstrokecolor=:green,ms=1.5)
s1b1b = annotate!(100, -43.5,text(L"i", :left, tfs))
s1b1b = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{2} ", :left, tfs,rotation=90))
s1b1b = annotate!(-200*0.5, 110.5, text(L"(\mathrm{c})", :left, tfs))
...
s1b2 = plot!(x_range, lb2 .- c2mle.*J, lw=0, fillrange=ub2 .- c2mle.*J, fillalpha=0.40,
         color=:green, label=false, grid=true, xlims=(1,200), ylims=(-30,30), tickfontsize=tfs, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-30,-20,-10,0,10,20,30], [latexstring("-30"),"","",latexstring("0"),"","",latexstring("30")]),linecolor=:transparent)

s1b2 = hline!([0],lw=2,ls=:dash,color=:black,legend=false)
s1b2 = annotate!(100, -48.2,text(L"i", :left, tfs))
s1b2 = annotate!(-100*0.65, -23, text(L"C_{s,0.9}^{\mathrm{o}} - \hat{C}_{s} ", :left, tfs,rotation=90))
s1b2 = annotate!(-200*0.5, 36.1, text(L"(\mathrm{d})", :left, tfs))
...
s2a=vline!([ρmle],lw=2)
s2a = annotate!(1, -4, text(L"ρ^\star", :left, tfs))
...
x_range = 1:1:200
x = 1:1:200
s2b1a = plot(x_range, lb1, lw=0, fillrange=ub1, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:red, label=false, grid=true, tickfontsize=tfs, margin=10mm, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s2b1a = plot!(x,c1mle.*J,color=:red,legend=false,lw=2,ls=:dash)
s2b1a = hline!([0],lw=2,ls=:dash,color=:black)
s2b1a = scatter!(1:step:200,data1,color=:red,markerstrokecolor=:red,ms=1.5)
s2b1a = annotate!(100, -43.5,text(L"i", :left, tfs))
s2b1a = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{1} ", :left, tfs,rotation=90))
#= s2b1a = annotate!(-200*0.5, 110.5, text(L"(\mathrm{f})", :left, tfs)) =#


s2b1b = plot(x_range, lb2, lw=0, fillrange=ub2, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:green, label=false, grid=true, tickfontsize=tfs, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s2b1b = plot!(x,c2mle.*J,color=:green,legend=false,lw=2,ls=:dash)
s2b1b = hline!([0],lw=2,ls=:dash,color=:black)
s2b1b = scatter!(1:step:200,data2,color=:green,markerstrokecolor=:green,ms=1.5)
s2b1b = annotate!(100, -43.5,text(L"i", :left, tfs))
s2b1b = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{2} ", :left, tfs,rotation=90))
#= s2b1b = annotate!(-200*0.5, 110.5, text(L"(\mathrm{g})", :left, tfs)) =#
...
s2b2 = annotate!(100, -48.2,text(L"i", :left, tfs))
s2b2 = annotate!(-100*0.65, -23, text(L"C_{s,0.9}^{\mathrm{o}} - \hat{C}_{s} ", :left, tfs,rotation=90))
#= s2b2 = annotate!(-200*0.5, 36.1, text(L"(\mathrm{h})", :left, tfs)) =#
...
s3a = annotate!(0.05, -4, text(L"λ_{1}^\star", :left, tfs))
...
x_range = 1:1:200
x = 1:1:200
s3b1a = plot(x_range, lb1, lw=0, fillrange=ub1, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:red, label=false, grid=true, tickfontsize=tfs, margin=10mm, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s3b1a = plot!(x,c1mle.*J,color=:red,legend=false,lw=2,ls=:dash)
s3b1a = hline!([0],lw=2,ls=:dash,color=:black)
s3b1a = scatter!(1:step:200,data1,color=:red,markerstrokecolor=:red,ms=1.5)
s3b1a = annotate!(100, -43.5,text(L"i", :left, tfs))
s3b1a = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{1} ", :left, tfs,rotation=90))
#= s3b1a = annotate!(-200*0.5, 110.5, text(L"(\mathrm{j})", :left, tfs)) =#


s3b1b = plot(x_range, lb2, lw=0, fillrange=ub2, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:green, label=false, grid=true, tickfontsize=tfs, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s3b1b = plot!(x,c2mle.*J,color=:green,legend=false,lw=2,ls=:dash)
s3b1b = hline!([0],lw=2,ls=:dash,color=:black)
s3b1b = scatter!(1:step:200,data2,color=:green,markerstrokecolor=:green,ms=1.5)
s3b1b = annotate!(100, -43.5,text(L"i", :left, tfs))
s3b1b = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{2} ", :left, tfs,rotation=90))
#= s3b1b = annotate!(-200*0.5, 110.5, text(L"(\mathrm{k})", :left, tfs)) =#
...
s3b2 = annotate!(100, -48.2,text(L"i", :left, tfs))
s3b2 = annotate!(-100*0.65, -23, text(L"C_{s,0.9}^{\mathrm{o}} - \hat{C}_{s} ", :left, tfs,rotation=90))
#= s3b2 = annotate!(-200*0.5, 36.1, text(L"(\mathrm{l})", :left, tfs)) =#
...
s4a = annotate!(0.05, -4, text(L"λ_{2}^\star", :left, tfs))
...
x_range = 1:1:200
x = 1:1:200
s4b1a = plot(x_range, lb1, lw=0, fillrange=ub1, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:red, label=false, grid=true, tickfontsize=tfs, margin=10mm, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s4b1a = plot!(x,c1mle.*J,color=:red,legend=false,lw=2,ls=:dash)
s4b1a = hline!([0],lw=2,ls=:dash,color=:black)
s4b1a = scatter!(1:step:200,data1,color=:red,markerstrokecolor=:red,ms=1.5)
s4b1a = annotate!(100, -43.5,text(L"i", :left, tfs))
s4b1a = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{1} ", :left, tfs,rotation=90))
#= s4b1a = annotate!(-200*0.5, 110.5, text(L"(\mathrm{n})", :left, tfs))
 =#

s4b1b = plot(x_range, lb2, lw=0, fillrange=ub2, fillalpha=0.40, xlims=(1,200), ylims=(-10,100),
         color=:green, label=false, grid=true, tickfontsize=tfs, framestyle=:box,
         xticks=([1,50,100,150,200], [latexstring("1"),"",latexstring("100"),"",latexstring("200")]),
         yticks=([-10,0,20,40,60,80,100], ["",latexstring("0"),"","","","",latexstring("100")]),linecolor=:transparent)
s4b1b = plot!(x,c2mle.*J,color=:green,legend=false,lw=2,ls=:dash)
s4b1b = hline!([0],lw=2,ls=:dash,color=:black)
s4b1b = scatter!(1:step:200,data2,color=:green,markerstrokecolor=:green,ms=1.5)
s4b1b = annotate!(100, -43.5,text(L"i", :left, tfs))
s4b1b = annotate!(-100*0.6, 45, text(L"C^{\mathrm{o}}_{2} ", :left, tfs,rotation=90))
#= s4b1b = annotate!(-200*0.5, 110.5, text(L"(\mathrm{o})", :left, tfs)) =#
...
s4b2 = annotate!(100, -48.2,text(L"i", :left, tfs))
s4b2 = annotate!(-100*0.65, -23, text(L"C_{s,0.9}^{\mathrm{o}} - \hat{C}_{s} ", :left, tfs,rotation=90))
#= s4b2 = annotate!(-200*0.5, 36.1, text(L"(\mathrm{p})", :left, tfs)) =#
